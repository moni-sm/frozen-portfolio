              ...
              <section className="home">
                <div className="home-content">
                  ...
                  <div className="brief-experience">
                    ...
                    <ul>
                      <li>
                        <strong>Food Delivery Web App (MERN Stack):</strong> Built a full-stack food delivery app with Stripe integration for payments. <a href="/projects">View Project</a>
                      </li>
                      <li>
                        <strong>Gemini Clone (React + Google API):</strong> Created a clone of the Gemini app using React and Google's API for AI-powered interactions. <a href="/projects">View Project</a>
                      </li>
                      <li>
                        <strong>Practice Projects:</strong> Developed fun games like Tic Tac Toe and Rock Paper Scissors to sharpen my skills. <a href="/projects">View Projects</a>
                      </li>
                      <li>
                        <strong>Round-Robin Distributor:</strong> Built a coupon distribution system that ensures users get a new coupon only after 60 minutes. <a href="/projects">View Project</a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="recent-updates">
                    ...
                    <ul>
                      <li>
                        <strong>New Project Added:</strong> Check out my latest project on the <a href="/projects">Projects</a> page.
                      </li>
                      <li>
